...
Version 0.2.0-alpha.3 is experimental and intended for the alpha channel. The owner-authorized latest alias remains on 0.2.0-alpha.1. For complete consumer setup, use the canonical [installation guide](https://github.com/adulash/adula-kit/blob/main/docs/installation.md). Full 1.0 acceptance remains pending.

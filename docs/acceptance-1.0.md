...
| 3 — Business features | Policies, templates/SSE, comments/mentions/followers/tags/changes, assignments, saved views, import, printing, HMAC webhooks, API tokens/OpenAPI, 2FA with human ASVS review | Implemented and tested 2026-09-25 (XLSX import is GAP-006); waits on the human 2FA ASVS review and owner acceptance. |
